  ...
  void readCertificates() {
    _certificates = [
      Certificate(
        ...
        date: '2023',
        skills:
            'Dart, Flutter, Firebase, Restful API, Dio, HTTP, Hive, Cubit, Provider',
        credential:
            'https://www.udemy.com/certificate/UC-fff0024a-4f0f-4a78-8f2a-3d268b6652ea/',
      ),
      Certificate(
        name: 'Git and GitHub',
        ...
        credential:
            'https://almdrasa.com/certificate-verification/14B418F08-14B31DA57-12CFA662B/',
      ),
      Certificate(
        ...
        credential:
            'https://drive.google.com/file/d/1MwelJQ7WZ0BVVCQq98dh8VrfP5bONbUk/view',
      ),
      Certificate(
        name: 'Flutter Development Basics Level Course',
        organization:
            'Egyptian Council for Training and Development - UN Women Egypt',
        date: '2024',
        skills: 'Dart, Flutter, Sqlite',
        credential:
            'https://drive.google.com/file/d/1fhdNVcwCPUnXOLqJxL6mteRlCsifPq4C/view',
      ),
    ];
    notifyListeners();
  }
